...
-- ── Shipping Zones ─────────────────────────────────────────────
-- Must stay in sync with migrations/add_shipping_zones.sql:
-- fresh databases bootstrap from this file and baseline that migration
-- without running it.
...
CREATE TABLE WholesaleInquiries (
    ...
    assigned_admin_id     INT            NULL REFERENCES Users(id),
