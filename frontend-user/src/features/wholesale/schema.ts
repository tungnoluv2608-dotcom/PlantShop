...
export const wholesaleSchema = z.object({
  ...
  timeline: z.string(),
  note: z.string(),
  interestedCategories: z.array(interestItemSchema).max(20),
  interestedProducts: z.array(interestItemSchema).max(20),
})

export type WholesaleFormValues = z.infer<typeof wholesaleSchema>
export type WholesaleInterestItem = z.infer<typeof interestItemSchema>